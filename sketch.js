...
coin3=createSprite(width-width+275,height-height+25,20,20)
...
coin1.lifetime=0
  ...
  textSize(18)
  if (DDT==0){
  text("Task - Run 1000 meter to get 10[" + "   ]",width-width+5,height-height+30) 
  }
  if (me>999){
  if (DDT==0){
  ...
  if (DDT===1){
  fill("green")
  text('Task Completed [Run 1000 meter] ',width-width+5,height-height+30)
  coin3.visible=false
    if (gamestate===end){
      aaaaa=2
    }
  ...
  textSize(18)
  if (DDT==0){
  text("Task-collect 3coin in one try for5[" + "   ]",width-width+5,height-height+30) 
  }
  if (coine>2){
  if (DDT==0){
  ...
  if (DDT===1){
  fill("green")
  text('Task Completed[collect 3coin]',width-width+5,height-height+30)
  coin3.visible=false
   if (gamestate===end){
      aaaaa=3
    }
  ...
  textSize(22)
  if (DDT==0){
  text("Task-jump30 time to get10[" + "  ]",width-width+5,height-height+30) 
  }
  if (jump>29){
  if (DDT==0){
  totalcoin=totalcoin+10 
  ...
  if (DDT===1){
  fill("green")
  text('Task Completed[jump 30 time]',width-width+5,height-height+30)
  coin3.visible=false
      if (gamestate===end){
  aaaaa=4
  }}}
  ...
  textSize(18)
  if (DDT==0){
  text("Task - Run 3000 meter to get 20[" + "   ]",width-width+5,height-height+30) 
  }
  if (me>2999){
  if (DDT==0){
  ...
  if (DDT===1){
  fill("green")
  text('Task Completed [Run 3000 meter] ',width-width+5,height-height+30)
  coin3.visible=false
      if (gamestate===end){
  aaaaa=5
  }}}
  ...
  textSize(18)
  if (DDT==0){
  text("Task-collect 5coin in one try for8[" + "   ]",width-width+5,height-height+30) 
  }
  if (coine>4){
  if (DDT==0){
  ...
  if (DDT===1){
  fill("green")
  text('Task Completed[collect 5coin]',width-width+5,height-height+30)
  coin3.visible=false
      if (gamestate===end){
  aaaaa=6
  }}}
  ...
  textSize(22)
  if (DDT==0){
  text("Task-jump50 time to get20[" + "  ]",width-width+5,height-height+30) 
  }
  if (jump>49){
  if (DDT==0){
  totalcoin=totalcoin+20 
  ...
  if (DDT===1){
  fill("green")
  text('Task Completed[jump 50 time]',width-width+5,height-height+30)
  coin3.visible=false
      if (gamestate===end){
  aaaaa=7
  }}}
  ...
  textSize(18)
  if (DDT==0){
  text("Task - Run 5000 meter to get 50[" + "   ]",width-width+5,height-height+30) 
  }
  if (me>4999){
  if (DDT==0){
  ...
  if (DDT===1){
  fill("green")
  text('Task Completed [Run 5000 meter] ',width-width+5,height-height+30)
  coin3.visible=false
      if (gamestate===end){
  aaaaa=8
  }}}
  ...
  textSize(22)
  if (DDT==0){
  text("Task-jump80 time to get30[" + "  ]",width-width+5,height-height+30) 
  }
  if (jump>79){
  if (DDT==0){
  totalcoin=totalcoin+30 
  DDT=1
  }
  }
  if (DDT===1){
  fill("green")
  text('Task Completed[jump 80 time]',width-width+5,height-height+30)
  coin3.visible=false
      if (gamestate===end){
  aaaaa=9
  }}}
  ...
  textSize(18)
  if (DDT==0){
  text("Task-Run 10000 meter to get100[" + "   ]",width-width+0,height-height+30) 
  }
  ...
  if (DDT===1){
  fill("green")
  text('Task Completed [Run 10000 meter] ',width-width+5,height-height+30)
  coin3.visible=false
  aaaaa=10
      if (gamestate===end){
  }}}
  ...
  textSize(18)
  if (DDT==0){
  text("  collect 20 coin in one try for 30[" + "    ]",width-width+5,height-height+30) 
  }
  if (coine>19){
  if (DDT==0){
  totalcoin=totalcoin+30
  ...
  if (DDT===1){
  fill("green")
  text('Task Completed[collect 20coin]',width-width+5,height-height+30)
  coin3.visible=false
  aaaaa=11
      if (gamestate===end){
  }}}
  ...
  textSize(22)
  if (DDT==0){
  text("jump150 time to get50[" + "  ]",width-width+5,height-height+30) 
  }
  ...
  if (DDT===1){
  fill("green")
  text('Task Completed[jump 150 time]',width-width+5,height-height+30)
  coin3.visible=false
      if (gamestate===end){
  aaaaa=12
  }}}
  ...
  textSize(18)
  if (DDT==0){
  text("Task-Run 50000 meter to get500[" + "   ]",width-width+0,height-height+30) 
  }
  if (me>49999){
  if (DDT==0){
  ...
  if (DDT===1){
  fill("green")
  text('Task Completed [Run 50000 meter] ',width-width+5,height-height+30)
  coin3.visible=false
      if (gamestate===end){
  aaaaa=13
  ...
  textSize(18)
  if (DDT==0){
  text("  collect 25 coin in one try for 50[" + "    ]",width-width+5,height-height+30) 
  }
  if (coine>24){
  if (DDT==0){
  totalcoin=totalcoin+50
  ...
  if (DDT===1){
  fill("green")
  text('Task Completed[collect 50coin]',width-width+5,height-height+30)
  coin3.visible=false
      if (gamestate===end){
  aaaaa=14
  }}}
 ...
 if (aaaaa===14){
  ...
  textSize(22)
  if (DDT==0){
  text("jump250 time to get80[" + "  ]",width-width+5,height-height+30) 
  }
  if (jump>249){
  if (DDT==0){
  totalcoin=totalcoin+80 
  DDT=1
  }
  }
  if (DDT===1){
  fill("green")
  text('Task Completed[jump 250 time]',width-width+5,height-height+30)
  coin3.visible=false
      if (gamestate===end){
  aaaaa=15
  }}}
  ...
  textSize(18)
  if (DDT==0){
  text("Run 100000 meter to get10000[" + "  ]",width-width+0,height-height+30) 
  }
  if (me>99999){
  if (DDT==0){
  ...
  if (DDT===1){
  fill("green")
  text('Task Completed [Run 100000 meter] ',width-width+5,height-height+30)
  coin3.visible=false
      if (gamestate===end){
  aaaaa=16
  }}}
  ...
  textSize(18)
  if (DDT==0){
  text("Last Task Run 500000 ",width-width+0,height-height+30) 
  }
  if (me>599999){
  if (DDT==0){
  totalcoin=totalcoin+9999999
  DDT=1
  }
  }
  if (DDT===1){
  fill("green")
  text('Task Completed [Run 500000 meter] ',width-width+5,height-height+30)
  coin3.visible=false
      if (gamestate===end){
  aaaaa=17
  }}}
